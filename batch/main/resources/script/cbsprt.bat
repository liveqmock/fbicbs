...
@echo 报表开始打印...
    print /d:lpt1 D:\fbicbs\batch\report\%BusinessDate%\010\日结单.txt
...
@echo 报表开始打印...
    ...
    print /d:lpt1 D:\fbicbs\batch\report\%BusinessDate%\010\简明余额表.txt
...
echo 日期： %BusinessDate%
@echo 报表开始打印...
    print /d:lpt1 D:\fbicbs\batch\report\%BusinessDate%\010\月计表.txt
...
echo 日期： %BusinessDate%
@echo 报表开始打印...
    print /d:lpt1 D:\fbicbs\batch\report\%BusinessDate%\010\总账.txt
...
echo 日期： %BusinessDate%
@echo 报表开始打印...
    print /d:lpt1 D:\fbicbs\batch\report\%BusinessDate%\010\对账单.txt
...
echo 日期： %BusinessDate%
@echo 报表开始打印...
    print /d:lpt1 D:\fbicbs\batch\report\%BusinessDate%\010\存款对账单回执.txt
...
echo 日期： %BusinessDate%
@echo 报表开始打印...
    print /d:lpt1 D:\fbicbs\batch\report\%BusinessDate%\010\损益表.txt
