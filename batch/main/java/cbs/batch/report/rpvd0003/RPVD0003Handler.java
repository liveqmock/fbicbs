    ...
    protected void processBusiness(BatchParameterData parameterData) {
        ...
        try {
            ...
            if (strarry.length != 3) {
                ...
                System.out.println("zh:" + strarry[0] + " start:" + strarry[1] + " end:" + strarry[2]);
                paramActacn = strarry[0].toString();
                paramBeginPage = Integer.parseInt(strarry[1].equals("") ? "0" : strarry[1]);
                paramEndPage = Integer.parseInt(strarry[2].equals("") ? "0" : strarry[2]);
//                System.out.println("zh:"+paramActacn + " start:"+paramBeginPage + " end:"+paramEndPage);
                ActnsmPrtPart();
            }
