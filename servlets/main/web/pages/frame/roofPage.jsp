...
<head>
    ...
    <script type="text/javascript">
        ...
        function Relogin() {
            ...
            parent.window.location.replace("/fbicbs2/pages/security/logout.jsp");
...
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" onbeforeunload="Relogin()" >
...
<table width="100%" cellpadding="0" cellspacing="0">
    <tr width="100%" height="50px" style="margin-bottom: 0px;margin-top:0px;margin:0px;padding:0px">
        <td width="50%" style="height:50" colspan="4">
            ...
            &nbsp;&nbsp;
            <image style="top-marign:0px;bottom-margin:0px;height:45" src="../../images/mpc.jpg"></image>
            <image style="top-marign:0px;bottom-margin:0px;height:50" src="../../images/cbs2.png"></image>
