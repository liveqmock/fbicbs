...
@ManagedBean
@ViewScoped
public class ActvchPrtAction implements Serializable {
    ...
    public String vchDataList() {
        ...
        final String orgidt = "010";
        final String orgnam = "资金管理中心";
        ...
        try {
            ...
            for (int item = 0; item < page; item++) {
                ...
                for (ActvchForGlDRpt stm : glcurLst.subList(from,to)) {
                    if (glcurLst.get(from)!=null){
                        ActvchForGlDRpt glcur = (ActvchForGlDRpt) glcurLst.get(from);
                    ...
                    if ((to-from)>1 && "".equals(glcode2)) {
                        ActvchForGlDRpt glcur = (ActvchForGlDRpt) glcurLst.get(to-1);
                        String glcode = glcur.getGlcode();
                        String curcde = glcur.getCurcde();
                        String glcnam = glcur.getGlcnam();
                        String curnmc = glcur.getCurnmc();
