		...
		try {
            ...
            */
            ...
            try {
                ...
                this.jsonMap.put("customer", mb.generateJsonStream(operid, "customer"));
                this.jsonMap.put("voucher", mb.generateJsonStream(operid, "voucher"));
                this.jsonMap.put("check", mb.generateJsonStream(operid, "check"));
                this.jsonMap.put("extsys", mb.generateJsonStream(operid, "extsys"));
                this.jsonMap.put("bizparam", mb.generateJsonStream(operid, "bizparam"));
