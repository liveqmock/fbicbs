...
public class OnLineOpersManager {
    ...
    public static synchronized boolean isSessionOnline(String sessionKey, ServletContext application) {
        HashMap<String,OperatorManager> userMaps = ((HashMap<String,OperatorManager>) application.getAttribute(ONLINE_USERS));
        return (userMaps != null) ?userMaps.containsKey(sessionKey): false;
    }
